...
- Being respectful of differing opinions, viewpoints, and experiences —
  including disagreement about technical direction, which is expected and
  healthy in a specification project
- Giving and gracefully accepting constructive feedback
- Accepting responsibility and apologizing to those affected by our
  mistakes, and learning from the experience
- Focusing on what is best not just for us as individuals, but for the
  overall community and the specification's long-term users
...
requests, RFC discussions, and any other official communication channel),
...
reported to the maintainers by opening a confidential report — see the
repository's contact information at
[github.com/tomaszbramson/FrogAI](https://github.com/tomaszbramson/FrogAI)
for the current reporting channel. All complaints will be reviewed and
